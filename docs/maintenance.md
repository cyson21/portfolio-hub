...
- 포함: 사용자 승인 연락처와 사진을 포함할 수 있는 단일 이력서 PDF, 전화번호를 제외한 이력서 HTML, 통합·인덱스·프로젝트별 포트폴리오 HTML, 공개 프로젝트 링크
- 전화번호는 사용자 승인된 resume.pdf에만 허용하며, 포트폴리오 HTML과 나머지 공개 자산에는 넣지 않습니다.
